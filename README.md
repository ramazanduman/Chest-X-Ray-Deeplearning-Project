...
Ayrıca drive üzerinde model eğitimleri kaydedilmiştir. Her model için farklı veri setleri üzerinde doğrulama çalışması yapılmış ve model başarıları gösterilmiştir. 
